...
⚡️ 아름다운 모던 디자인\
⚡️ 싱글 페이지 어플리케이션 빌드 with React & Redux\
...
**성능 향상**:\
 [react-window](https://www.npmjs.com/package/react-window) 라이브러리를 사용해 보이는 부분만을 돔을 시각화하여 마운트 시 렌더링을 빠르게 하였습니다.
<br/>
...
**성능 향상**:\
[react-infinite-scroller](https://www.npmjs.com/package/react-infinite-scroller)를 사용해 데이터 요청을 페이지네이션 하여 돔에 빠르게 페인팅 하였습니다.
<br/>
...
**[라이브로 보기 ](https://bind-5d6a6.firebaseapp.com/)**
...
- [Thunk](https://www.npmjs.com/package/redux-thunk) - 비동기 디스패치를 ​​수행하는 함수를 반환할 수 있게 해주는 Redux 미들웨어
- [React-Router](https://reactrouter.com/) - SPA 라우팅 라이브러리
- [React](https://es.reactjs.org/) - 프론트 엔드 자바스크립트 라이브러리
- [Material-UI](https://material-ui.com/) - 리액트 컴포넌트 UI 라이브러리
...
- [react-window](https://www.npmjs.com/package/react-window) - 초기 렌더링과 업데이트를 처리하는데 시간을 줄여주는 렌더링 최적화 라이브러리
